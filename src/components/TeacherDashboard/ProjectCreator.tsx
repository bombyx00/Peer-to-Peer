  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '24px', alignItems: 'start' }}>
      ...
      <div className="glass-panel" style={{ padding: '28px' }}>
        <h3 style={{ fontSize: '23px', fontWeight: 700, marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px', fontFamily: 'var(--font-yeongwol)' }}>
        ...
        <form onSubmit={handleSubmit} onKeyDown={handleKeyDown} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div>
            <label style={{ display: 'block', fontSize: '15px', fontWeight: 700, color: 'var(--text-secondary)', marginBottom: '8px', fontFamily: 'var(--font-yeongwol)' }}>
              프로젝트 제목
            </label>
            <input
              type="text"
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            />
            <label htmlFor="selfEval" style={{ fontSize: '15px', fontWeight: 700, color: 'var(--text-secondary)', cursor: 'pointer', fontFamily: 'var(--font-yeongwol)' }}>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <label style={{ fontSize: '17px', fontWeight: 700, fontFamily: 'var(--font-yeongwol)' }}>평가 문항 설계 ({questions.length})</label>
          ...
          <button type="submit" className="btn btn-primary" style={{ width: '100%', marginTop: '10px', fontSize: '16px', fontFamily: 'var(--font-yeongwol)', fontWeight: 'bold' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <div className="glass-panel" style={{ padding: '24px' }}>
          <h3 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '16px', fontFamily: 'var(--font-yeongwol)' }}>진행 중인 평가 목록</h3>
              ...
              projects.map((proj) => (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '8px' }}>
                    <h4 style={{ fontSize: '16px', fontWeight: 700, color: proj.active ? 'var(--text-primary)' : 'var(--text-muted)', fontFamily: 'var(--font-yeongwol)' }}>
                      {proj.title}
                    </h4>
                    <span style={{
                      fontSize: '11px',
